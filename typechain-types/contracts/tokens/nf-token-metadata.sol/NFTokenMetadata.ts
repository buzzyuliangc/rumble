...
export interface NFTokenMetadataInterface extends utils.Interface {
  functions: {
...
export interface NFTokenMetadata extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTokenMetadataInterface;
