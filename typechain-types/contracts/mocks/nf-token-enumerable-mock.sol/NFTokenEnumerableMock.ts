...
export interface NFTokenEnumerableMockInterface extends utils.Interface {
  functions: {
...
export interface NFTokenEnumerableMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTokenEnumerableMockInterface;
