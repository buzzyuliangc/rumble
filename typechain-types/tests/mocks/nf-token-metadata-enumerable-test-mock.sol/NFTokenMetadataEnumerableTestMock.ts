...
export interface NFTokenMetadataEnumerableTestMockInterface
...
export interface NFTokenMetadataEnumerableTestMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTokenMetadataEnumerableTestMockInterface;
