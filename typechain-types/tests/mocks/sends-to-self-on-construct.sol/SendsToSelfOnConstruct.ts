...
export interface SendsToSelfOnConstructInterface extends utils.Interface {
  functions: {
...
export interface SendsToSelfOnConstruct extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SendsToSelfOnConstructInterface;
