...
export interface NFTokenTestMockInterface extends utils.Interface {
  functions: {
...
export interface NFTokenTestMock extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NFTokenTestMockInterface;
